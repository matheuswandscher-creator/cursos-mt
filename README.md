...
<body>
    ...
    <header>
        <div class="header-container">
            ...
            <a href="#planos" class="cta-btn">Garantir Meu Acesso</a>
        </div>
    </header>
    ...
    <main>
        ...
        <section id="pagamento" class="pix-section">
            ...
            <p class="pix-instruction">Escolha o valor do plano desejado acima e faça a transferência para a chave abaixo:</p>
            
            <div class="pix-key-box" title="Clique para selecionar">15998015908</div>
            
            <p class="pix-instruction" style="font-size: 0.85rem; margin-top: 15px;">
                💡 <strong>Dica:</strong> Após realizar o PIX do plano escolhido (R$ 15,25, R$ 12,90 ou R$ 100,00), envie o comprovante para o nosso suporte para liberação imediata das suas figurinhas e vantagens!
            </p>
        </section>
